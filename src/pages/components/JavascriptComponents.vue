<template>
  <div id="javascriptComponents" class="section section-javascript">
      ...
      <div id="modals" class="row">
        <div class="col-md-6 modal-buttons">
          ...
          <n-button type="primary" @click.native="modals.classic = true">
            <i class="now-ui-icons files_single-copy-04"/> Classic
          </n-button>
          <n-button type="primary" @click.native="modals.mini = true">
            <i class="now-ui-icons media-1_button-power"/> Launch Modal Mini
          </n-button>
          <n-button type="primary" @click.native="modals.notice = true">
            <i class="now-ui-icons travel_info"/> Notice
          </n-button>
          <n-button type="primary" @click.native="modals.login = true">
            <i class="now-ui-icons users_single-02"/> Login Modal
          </n-button>
        </div>
          ...
          <div class="row">
            <div class="col-md-8">
              ...
              <p class="description">The first step is to create an account at <a
                href="https:///www.creative-tim.com/">Creative Tim</a>. You can choose a social
                network or
    ...
    <modal
      ...
      class="modal-primary">
      <div slot="base-content" class="card card-plain card-login" data-background-color="">
