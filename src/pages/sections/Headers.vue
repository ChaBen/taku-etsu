<template>
  <div id="headers" class="cd-section" >
    ...
    <div class="header-1">
      <nav class="navbar navbar-expand-lg navbar-transparent bg-primary navbar-absolute">
        <div class="container">
          ...
          <div id="example-navbar-primary2" class="collapse navbar-collapse">
      ...
      <div class="page-header header-filter">
        <div class="page-header-image" style="background-image: url('img/bg16.jpg')"/>
        <div class="content-center">
          <div class="container">
            <div class="row">
              <div class="col-md-7 ml-auto text-right">
                <h1 class="title">History of surfing</h1>
                <h4 class="description">The riding of waves has likely existed since humans began
    ...
    <div class="header-2">
      ...
      <div class="page-header header-filter">
        <div class="page-header-image" style="background-image: url('img/bg14.jpg')"/>
        <div class="content-center">
          <div class="container">
            <div class="row">
              <div class="col-md-8 ml-auto mr-auto text-center">
                <h1 class="title"> You should be here!</h1>
                <h5 class="description">5,000 capacity venue, holding some of the latest technology
                ...
                <div class="card card-raised card-form-horizontal card-plain" data-background-color>
                  <div class="card-body">
                    <form method="" action="">
                      <div class="row">
                        <div class="col-md-3">
                          <fg-input value="" placeholder="Full Name"/>
                        </div>
                        <div class="col-md-3">
                          <fg-input value="" placeholder="Your Email"/>
                        </div>
                        <div class="col-md-3">
                          <fg-input value="" placeholder="Password"/>
                        </div>
                        <div class="col-md-3">
                    ...
                    <div class="col-md-6 text-left">
                      ...
                      <div class="buttons">
                        <a href="#pablo" class="btn btn-neutral btn-primary btn-lg mr-1">
                          <i class="now-ui-icons files_single-copy-04"/> Read More..
                        </a>
                        <a href="#pablo" class="btn btn-primary btn-lg">
                          <i class="now-ui-icons arrows-1_share-66"/> Subscribe
                        </a>
                      </div>
                    </div>
                  </div>
